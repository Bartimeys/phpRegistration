<form id="registration" name="registration" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form form-login">
    <div class="form-field">
        ...
        <input id="email" type="email" class="form-input" name="email" placeholder="example@example.com" required>
    </div>
    <div class="form-field">
        <label class="birthday" for="birthday">Birthday</label>
        <input id="birthday" type="date" class="form-input" name="birthday" placeholder="dd/mm/yyyy" required/>
    </div>
